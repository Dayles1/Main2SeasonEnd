    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <div class="flex flex-wrap justify-center sm:justify-start space-x-4">
                <span class="font-semibold">{{count(auth()->user()->followers)}} Followers</span>
                <span class="font-semibold">{{count(auth()->user()->following)}} Following</span>
                <span class="font-semibold"> {{count(auth()->user()->posts)}} Posts</span>
            </div>
        </div>
