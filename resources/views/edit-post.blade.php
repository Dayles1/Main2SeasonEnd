...
<main class="flex-grow container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <a href="/show-post.html" class="text-indigo-600 hover:text-indigo-800 underline mb-4">Back</a>
        <form>
            <div class="mb-4">
                <label for="title" class="block text-sm font-medium text-gray-700">Title</label>
                <input type="text" id="title" name="title" required
                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                    value="Existing Post Title" autofocus>
            </div>
            <div class="mb-4">
                ...
                <textarea id="description" name="description" rows="4" required
                    ...
                    spellcheck="false">Existing post description...</textarea>
            </div>
            <div class="mb-4">
                ...
                <p class="mt-2 text-sm text-gray-500">Current image: existing-image.jpg</p>
            </div>
            <button type="submit"
